    ...
    return (
        <main className="px-4 py-8 flex flex-col items-center justify-center min-h-screen w-screen max-w-full ">
            ...
            <h1 className=" text-4xl font-semibold text-center my-14 lg:my-20">Medical Billing Miami Beach</h1>
                ...
                <section className='max-w-5xl grid md:grid-cols-2 gap-4' >
                    ...
                    <button
                            className={` col-span-2 bg-primary text-white w-full py-2 rounded-md mx-auto max-w-md my-4 tracking-wider ${(checkLength(agreement, 11)) ? ' grayscale cursor-not-allowed ' : 'grayscale-0'} `}
