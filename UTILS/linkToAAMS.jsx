...
const LinkToAIMS = () => {
    return (
        <article className="shine text-center relative w-11/12 min-h-32 max-w-full px-5 py-12 md:py-0 lg:max-w-3xl mx-auto overflow-hidden flex flex-col md:flex-row items-center justify-end bg-gradient-to-br from-blue-400 via-teal-400 to-indigo-500 rounded-xl shadow-2xl shadow-gray-800 ">
            <Image
                src={`/raster/AIMS-logo.png`}
                alt={'AI Medical Scriber'}
                width={120}
                height={14}
                className={'inline-block rounded-lg mr-1 w-20 md:w-24'}
            />
